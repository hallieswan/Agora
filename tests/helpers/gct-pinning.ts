...
export const expectPinnedGenesCountText = async (
  page: Page,
  nGenes: number
) => {
...
export const expectPinnedProteinsCountText = async (
  page: Page,
  nProteins: number
) => {
...
export const confirmPinnedItemsByItemName = async (
  page: Page,
  itemNames: string[]
) => {
...
export const confirmPinnedProteins = async (
  page: Page,
  geneName: string,
  proteins: string[]
) => {
...
export const pinMultipleGenesViaSearch = async (
  page: Page,
  geneNames: string[]
) => {
...
export const pinAllItemsViaSearchByGene = async (
  page: Page,
  geneName: string
) => {
